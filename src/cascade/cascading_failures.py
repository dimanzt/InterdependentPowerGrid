...
if __name__ == '__main__':
    ...
    for i in range(51):
        ...
        for j in range(it):
            ...
            remove_nodes = set([])
            k = 0
            while (len(remove_nodes) < min((num_nodes * (i) / N), num_nodes)) :
            ...
            removed_g1, removed_g2= cascading_failures_ping_pong(hviet, garr, remove_nodes, h_inter, g_inter)
            ...
            print 'removed_g2:'
            print removed_g2
            sum += (removed_g1) #len(hviet)
            sum2 += (removed_g2) #len(garr)
            ...
            #Diman
        g1_failed.append(removed_g1 / float(num_nodes))
        g2_failed.append(removed_g2 / float(num_nodes2))

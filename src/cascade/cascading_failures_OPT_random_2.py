...
if __name__ == '__main__':
    ...
    for i in range(51):#51
        ...
        for j in range(it):
            ...
            ########################################
            """
            while (len(remove_nodes) <  min((num_nodes * (i*2) / N), num_nodes)):#num_nodes * i / N:
            ...
            Steps, removed_g1_edges, removed_g1_nodes, removed_g2, TotalPowerAllGraphs= Let_it_Cascade(hviet, garr, init_removed_g1_edges, init_removed_g1, init_removed_g2, h_inter, g_inter, i*2, N, j)
            """

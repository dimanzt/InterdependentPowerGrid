...
Thr = 0.31
[flows_0, ILP_gen_power_0, ILP_load_power_0, cost_0, TotalPower_0] = optimal_no_cascade_power(nodes, power, link1, link2, linkNum, 0.3)
print 'Flows:'
print flows
print 'ILP_gen_power:'
print ILP_gen_power
...
for j in range(0, repeat):
    for i in range(0, N):
        ...
        [flows, ILP_gen_power, ILP_load_power, cost, TotalPower] = optimal_no_cascade_power(nodes, power, link1, link2, linkNum, Thr)
        #[flows, ILP_gen_power, ILP_load_power, cost, TotalPower] = optimal_cascade_power(nodes, power, link1, link2, linkNum)

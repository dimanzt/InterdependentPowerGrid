...
# Model data
def optimal_cascade_power(nodes, power, link1, link2, linkNum):
    flows = []
    cost = []
    Total_power = []
    ILP_gen_power = []
...
def cascade_solution_best(nodes, power, link1, link2, linkNum):
    #Power_gen_t = []
    #Power_load_t = []
    my_flows = []
    ILP_gen = []

...
############################
# Model data
def optimal_Max_R(nodes, power, link1, link2, reactances, linkNum, Thr, removed_edges, removed_power, removed_index, Original_link1, Original_link2, Original_reactances):
    flows = []
    cost = []
    Total_power = []
    ILP_gen_power = []
    ...
    [Flow_inTime, repairs, time] = Max_R_solution_greedy(nodes, power, link1, link2, reactances, linkNum, Thr, removed_edges, removed_power, removed_index, Original_link1, Original_link2, Original_reactances, Added_Flows, NumRepairs)
...
def Max_R_solution(nodes, power, link1, link2, reactances, linkNum, Thr, removed_edges, removed_power, removed_index, Original_link1, Original_link2, Original_reactances, Added_Flows, NumRepairs):
    repairs = []
    time = []
    ################################################################################################################
    New_link1 = []
...
def Max_R_solution_greedy(nodes, power, link1, link2, reactances, linkNum, Thr, removed_edges, removed_power, removed_index, Original_link1, Original_link2, Original_reactances, Added_Flows, NumRepairs):
    repairs = []
    time = []
    ################################################################################################################
    New_link1 = []
